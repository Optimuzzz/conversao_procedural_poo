        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                ?>
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800">Alterar senha: <?php echo $row["nome"]; ?></h1>
                    


                    <!-- Nome, e-mail, login, senha, perfil(adm/user) -->

                    <form action="atualizar-senha.php" method="post" autocomplete="off" class="w-50"> 
                    ...
                    <!-- <div class="form-group">   
                        <label for="e-mail">Confirme a sua senha</label>
                        <input type="e-mail" class="form-control" id="e-mail" name="email" required>
                    </div>  -->
                    ...
                    <button class="btn btn-primary mt-3">Atualizar senha </button>
