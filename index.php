                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form  method="post" autocomplete="off" > 
                                        ...
                                        <button class="btn btn-primary btn-user btn-block" id="btn_login" type="button">
                                            Login
                                        </button>
                                        <!-- add novo -->
                                        <div class='alert alert-danger mt-3 d-none' id="msg_login">
